...
static void
na_fixed_tip_parent_size_allocated (CtkWidget     *parent G_GNUC_UNUSED,
...
static void
na_fixed_tip_parent_screen_changed (CtkWidget  *parent G_GNUC_UNUSED,
				    CdkScreen  *new_screen G_GNUC_UNUSED,
				    NaFixedTip *fixedtip)
{
  na_fixed_tip_position (fixedtip);
}
