...
int		panel_find_applet_index	(CtkWidget *widget);

void		panel_push_window_busy	(CtkWidget *window);
void		panel_pop_window_busy	(CtkWidget *window);
...
char *          panel_find_icon         (CtkIconTheme  *icon_theme,
					 const char    *icon_name,
					 int            size);
cairo_surface_t *panel_load_icon        (CtkIconTheme  *icon_theme,
					 const char    *icon_name,
					 int            size,
					 int            desired_width,
					 int            desired_height,
...
char *guess_icon_from_exec (CtkIconTheme *icon_theme,
			    const gchar  *exec);
...
void panel_util_set_tooltip_text (CtkWidget  *widget,
				  const char *text);
